...
public class JaxRsServerConfig {
	...
	public Server jaxRsServer() {
		...
		factory.setServiceBeans(Arrays.<Object> asList(restAdminService()));
	...
	/**
   * Bean to return the Jackson JSON provider to create and parse JSON objects.
  ...
  /**
   * Bean to hold the exception mapper provider. Use to map the exceptions for this service.
   *
